---
url: "https://operating-system-in-1000-lines.vercel.app/en/04-boot"
title: "Booting the Kernel | OS in 1,000 Lines"
---

[Skip to content](https://operating-system-in-1000-lines.vercel.app/en/04-boot#VPContent)

On this page

# Booting the Kernel [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#booting-the-kernel)
...
## Supervisor Binary Interface (SBI) [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#supervisor-binary-interface-sbi)
...
## Let's boot OpenSBI [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#let-s-boot-opensbi)
...
## Linker script [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#linker-script)
...
## Minimal kernel [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#minimal-kernel)
...
### The kernel entry point [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#the-kernel-entry-point)
...
### `boot` function attributes [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#boot-function-attributes)
...
### `extern char` to get linker script symbols [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#extern-char-to-get-linker-script-symbols)
...
We can also declare it as `extern char __bss;`, but `__bss` alone means _"the value at the 0th byte of the `.bss` section"_ instead of _"the start address of the `.bss` section"_. Therefore, it is recommended to add `[]` to ensure that `__bss` returns an address and prevent any careless mistakes.

### `.bss` section initialization [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#bss-section-initialization)
...
## Let's run! [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#let-s-run)
...
## Your first kernel debugging [​](https://operating-system-in-1000-lines.vercel.app/en/04-boot\#your-first-kernel-debugging)
