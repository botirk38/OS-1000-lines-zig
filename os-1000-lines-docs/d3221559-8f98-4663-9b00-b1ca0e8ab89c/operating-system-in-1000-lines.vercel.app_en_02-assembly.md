...
This is _"inline assembly"_, a syntax for embedding assembly into C code. While you can write assembly in a separate file ( `.S` extension), using inline assembly is generally preferred because:
